        ...
        child: ClipRRect(
          child: BackdropFilter(
            ...
            child: AppBar(
              ...
              title:const Text(
                'Discover',
                style:  TextStyle(color: Colors.white),//Theme.of(context).textTheme.titleLarge,
              ),
              centerTitle: false,
              actions: [
                IconButton(
                      ...
                      children: [
                        ...
                        ListTile(
                          title: Text(
                            ...
                            style:const TextStyle(color: Colors.white),// Theme.of(context).textTheme.bodyLarge,
                          ),
                          ...
                          trailing: Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: const TextStyle(color: Colors.white),//Theme.of(context).textTheme.bodyMedium,
                              ),
                              Text(
                                  data[index]
                                          .priceChangePercentage7DInCurrency
                          ...
                          subtitle: Text(data[index].symbol!.toUpperCase(),
                              style: const TextStyle(color: Colors.white)),//Theme.of(context).textTheme.bodySmall),
                        ),
                      ],
                    );
                  });
